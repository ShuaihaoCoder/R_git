...
5. Read the annotated code again and remove comments that repeat obvious code or make the file harder to follow.
6. Run the language's syntax or parse check after editing when one is available.
