...
message("URL: ", app_url)
message("Open the URL above if RStudio does not open the browser automatically.")
shiny::runApp(project_dir, host = selected_host, port = selected_port, launch.browser = FALSE)
